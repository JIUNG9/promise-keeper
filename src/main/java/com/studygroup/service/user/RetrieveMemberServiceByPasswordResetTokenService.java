...
public class RetrieveMemberServiceByPasswordResetTokenService implements RetrieveMemberByToken {
  ...
  public Member getMember(String token) {
    return Optional.
        ofNullable(userRepository.findMemberByEmailTokenListByConfirmationToken(token,
            TokenType.PASSWORD_RESET_TOKEN)).
        orElseThrow(BindParameterSupplier.bind(CustomIllegalArgumentException::new,
