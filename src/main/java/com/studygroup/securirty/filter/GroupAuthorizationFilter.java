...
public class GroupAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !path.contains("/groups") || path.matches("/api/groups");
    }
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (path.contains("/admins")) {
                ...
                if (!groupRole.equals(GroupRole.GROUP_USER)
                        && !groupRole.equals(GroupRole.GROUP_ADMIN)) {
                    throw new GroupMemberAuthorizationException(
                            ErrorCode.YOU_ARE_NOTE_GROUP_MEMBER.getMessage());
                }
            }
        ...
        catch (GroupAdminAuthorizationException e) {
