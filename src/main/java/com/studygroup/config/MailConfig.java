...
import com.studygroup.util.constant.SmtpEmailInformation;
    ...
    public Authenticator setAuth() {
        return new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(SmtpEmailInformation.email,SmtpEmailInformation.emailPassword);
            }
        };
    }
